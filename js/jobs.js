  ...
  const jobList = [
    {
      ...
      appInstructions: 'Submit a single PDF file via <a href=http://apply.interfolio.com/129854 target="blank">Interfolio</a> named "<i>LASTNAME</i>_<i>FIRSTNAME</i>_S4E_202406.pdf" containing a cover letter, CV, and contact information for 3 references. The cover letter should address each point of the qualifications list explicitly (<i>i.e.</i>, A, B, C, ...). OPTIONAL: DOIs for 3 recent and relevant publications can be included at the end of the packet. Questions can be sent to the <i>S4E</i> team (jobs AT s4e.ai); subject line must contain "S4E Post-Doc".',
      appInstructions: 'Prepare a single PDF file named "<i>LASTNAME</i>_<i>FIRSTNAME</i>_S4E_202406.pdf" containing a cover letter, CV, and contact information for 3 references. Send your submission to the <i>S4E</i> team (jobs AT s4e.ai); subject line must contain "S4E Post-Doc: Application Submission". The cover letter should address each point of the qualifications list explicitly (<i>i.e.</i> A,B,C, ...). OPTIONAL: DOIs for 3 recent and relevant publications can be included at the end of the packet. Questions can be sent to Dr. Corey Oses (corey AT jhu.edu).',
    },
    {
      open: 'May 31, 2023',
